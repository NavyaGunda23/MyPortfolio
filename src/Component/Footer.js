...
const Footer = () => {
    return(
        ...
        <div className="container text-center py-5">
            ...
            <p className="m-0">&copy; <a className="text-white font-weight-bold" href="#">Domain Name</a>. All Rights Reserved. Designed by <a className="text-white font-weight-bold">Navya Gunda</a>
            </p>
        </div>
    </div>
    )
